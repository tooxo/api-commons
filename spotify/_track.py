...
from spotify._album import Album
from spotify._artist import Artist
from spotify._support_classes import ExternalIds, ExternalUrls
...
class Track:
    ...
    def from_api_response(cls, api_response: str) -> "Track":
        ...
        return cls(album=Album.from_api_response(
            json.dumps(parsed_api_response["album"])),
            artists=[Artist.from_api_response(json.dumps(x)) for x in
                     parsed_api_response["artists"]],
